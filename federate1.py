...
def main():
    ...
    subid1 = h.helicsFederateRegisterSubscription(fed, "DistributionSim_B2_G_1/voltage1", "")
    ...
    for t in range(0, seconds, 60 * 5):
        ...
        VrValue, ViValue = h.helicsInputGetComplex(subid1)
        ...
        logger.info("Voltage value = {} V".format(complex(VrValue, ViValue)/1))
